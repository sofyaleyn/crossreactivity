...
LAYER_A = paths.LAYER_A_CSV
# Layer C sequence-filled intermediate produced by layer_c.py. Run layer_c
# before merge. (Historically this read the raw seed, which left the mimicry
# rows without sequences merged in — see docs/reference-set.md.)
LAYER_C = paths.LAYER_C_FILLED
OUT = paths.SELF_PROTEINS
